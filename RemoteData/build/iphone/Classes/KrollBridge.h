...
@interface RemoteDataObject : KrollCoverageObject {
#else
@interface RemoteDataObject : KrollObject {
#endif
@private
...
extern NSString * RemoteData$ModuleRequireFormat;
