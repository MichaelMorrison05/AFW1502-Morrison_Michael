...
//@interface RemoteDataObject : NSObject
//@end

@interface RemoteDataObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[RemoteDataObject class]])
		{
			for (NSString *key in [[(RemoteDataObject*)o modules] allKeys])
			{
