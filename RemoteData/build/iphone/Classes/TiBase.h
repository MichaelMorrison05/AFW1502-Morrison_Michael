...
// in simulator we redefine to format for RemoteData Developer console
...
{\
	NSString * exceptionName = [@"org.remotedata." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.remotedata";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIRemoteDataNativeItemNone = -1, 
	UIRemoteDataNativeItemSpinner = -2,
	UIRemoteDataNativeItemProgressBar = -3,
	
	UIRemoteDataNativeItemSlider = -4,
	UIRemoteDataNativeItemSwitch = -5,
	UIRemoteDataNativeItemMultiButton = -6,
	UIRemoteDataNativeItemSegmented = -7,
	
	UIRemoteDataNativeItemTextView = -8,
	UIRemoteDataNativeItemTextField = -9,
	UIRemoteDataNativeItemSearchBar = -10,
	
	UIRemoteDataNativeItemPicker = -11,
	UIRemoteDataNativeItemDatePicker = -12,
	
	UIRemoteDataNativeItemInfoLight = -13,
	UIRemoteDataNativeItemInfoDark = -14,
	
	UIRemoteDataNativeItemDisclosure = -15,
	
	UIRemoteDataNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all RemoteData instances of
