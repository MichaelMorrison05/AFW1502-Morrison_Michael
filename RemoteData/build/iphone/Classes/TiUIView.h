...
/**
 Base class for all RemoteData views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the RemoteData view hierarchy (such as wrapped iOS UIViews) was touched.
