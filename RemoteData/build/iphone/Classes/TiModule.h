...
/**
 The base class for all RemoteData modules
 */
...
/**
 RemoteData Platform calls this method on startup.
 */
-(void)startup;

/**
 RemoteData Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 RemoteData Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 RemoteData Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 RemoteData Platform calls this method on resume.
 @param sender The sender of the event.
 */
