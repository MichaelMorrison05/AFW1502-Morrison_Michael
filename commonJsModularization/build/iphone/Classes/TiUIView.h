...
/**
 Base class for all commonJsModularization views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the commonJsModularization view hierarchy (such as wrapped iOS UIViews) was touched.
