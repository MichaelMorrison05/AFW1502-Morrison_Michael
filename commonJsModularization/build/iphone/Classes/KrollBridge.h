...
@interface commonJsModularizationObject : KrollCoverageObject {
#else
@interface commonJsModularizationObject : KrollObject {
#endif
@private
...
extern NSString * commonJsModularization$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	commonJsModularizationObject *_commonjsmodularization;
    KrollObject* console;
	BOOL shutdown;
