 ...
 * to send analytic data that can be viewed on the commonJsModularization Dashboard.
 *
 * For information on getting started with commonJsModularization Platform Services,
