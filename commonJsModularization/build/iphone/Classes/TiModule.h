...
/**
 The base class for all commonJsModularization modules
 */
...
/**
 commonJsModularization Platform calls this method on startup.
 */
-(void)startup;

/**
 commonJsModularization Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 commonJsModularization Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 commonJsModularization Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 commonJsModularization Platform calls this method on resume.
 @param sender The sender of the event.
 */
