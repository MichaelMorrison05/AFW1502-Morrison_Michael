...
//Rare exceptions to indicate a bug in the _commonjsmodularization code (Eg, function that a subclass should have implemented)
...
/**
 The base class for commonJsModularization proxies.
 */
