...
// in simulator we redefine to format for commonJsModularization Developer console
...
{\
	NSString * exceptionName = [@"org.commonjsmodularization." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.commonjsmodularization";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIcommonJsModularizationNativeItemNone = -1, 
	UIcommonJsModularizationNativeItemSpinner = -2,
	UIcommonJsModularizationNativeItemProgressBar = -3,
	
	UIcommonJsModularizationNativeItemSlider = -4,
	UIcommonJsModularizationNativeItemSwitch = -5,
	UIcommonJsModularizationNativeItemMultiButton = -6,
	UIcommonJsModularizationNativeItemSegmented = -7,
	
	UIcommonJsModularizationNativeItemTextView = -8,
	UIcommonJsModularizationNativeItemTextField = -9,
	UIcommonJsModularizationNativeItemSearchBar = -10,
	
	UIcommonJsModularizationNativeItemPicker = -11,
	UIcommonJsModularizationNativeItemDatePicker = -12,
	
	UIcommonJsModularizationNativeItemInfoLight = -13,
	UIcommonJsModularizationNativeItemInfoDark = -14,
	
	UIcommonJsModularizationNativeItemDisclosure = -15,
	
	UIcommonJsModularizationNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all commonJsModularization instances of
