...
//@interface commonJsModularizationObject : NSObject
//@end

@interface commonJsModularizationObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[commonJsModularizationObject class]])
		{
			for (NSString *key in [[(commonJsModularizationObject*)o modules] allKeys])
			{
