...
//@interface WK1Project1Object : NSObject
//@end

@interface WK1Project1Object (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WK1Project1Object class]])
		{
			for (NSString *key in [[(WK1Project1Object*)o modules] allKeys])
			{
