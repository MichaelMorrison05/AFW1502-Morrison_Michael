...
/**
 The base class for all WK1Project1 modules
 */
...
/**
 WK1Project1 Platform calls this method on startup.
 */
-(void)startup;

/**
 WK1Project1 Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 WK1Project1 Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 WK1Project1 Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 WK1Project1 Platform calls this method on resume.
 @param sender The sender of the event.
 */
