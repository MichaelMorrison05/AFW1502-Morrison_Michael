...
// in simulator we redefine to format for WK1Project1 Developer console
...
{\
	NSString * exceptionName = [@"org.wk1project1." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wk1project1";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWK1Project1NativeItemNone = -1, 
	UIWK1Project1NativeItemSpinner = -2,
	UIWK1Project1NativeItemProgressBar = -3,
	
	UIWK1Project1NativeItemSlider = -4,
	UIWK1Project1NativeItemSwitch = -5,
	UIWK1Project1NativeItemMultiButton = -6,
	UIWK1Project1NativeItemSegmented = -7,
	
	UIWK1Project1NativeItemTextView = -8,
	UIWK1Project1NativeItemTextField = -9,
	UIWK1Project1NativeItemSearchBar = -10,
	
	UIWK1Project1NativeItemPicker = -11,
	UIWK1Project1NativeItemDatePicker = -12,
	
	UIWK1Project1NativeItemInfoLight = -13,
	UIWK1Project1NativeItemInfoDark = -14,
	
	UIWK1Project1NativeItemDisclosure = -15,
	
	UIWK1Project1NativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WK1Project1 instances of
