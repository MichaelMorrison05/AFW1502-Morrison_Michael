...
@interface WK1Project1Object : KrollCoverageObject {
#else
@interface WK1Project1Object : KrollObject {
#endif
@private
...
extern NSString * WK1Project1$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	WK1Project1Object *_wk1project1;
    KrollObject* console;
	BOOL shutdown;
