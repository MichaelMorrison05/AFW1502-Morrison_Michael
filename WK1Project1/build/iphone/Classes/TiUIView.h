...
/**
 Base class for all WK1Project1 views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WK1Project1 view hierarchy (such as wrapped iOS UIViews) was touched.
