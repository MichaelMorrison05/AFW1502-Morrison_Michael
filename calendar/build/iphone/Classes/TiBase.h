...
// in simulator we redefine to format for calendar Developer console
...
{\
	NSString * exceptionName = [@"org.calendar." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.calendar";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIcalendarNativeItemNone = -1, 
	UIcalendarNativeItemSpinner = -2,
	UIcalendarNativeItemProgressBar = -3,
	
	UIcalendarNativeItemSlider = -4,
	UIcalendarNativeItemSwitch = -5,
	UIcalendarNativeItemMultiButton = -6,
	UIcalendarNativeItemSegmented = -7,
	
	UIcalendarNativeItemTextView = -8,
	UIcalendarNativeItemTextField = -9,
	UIcalendarNativeItemSearchBar = -10,
	
	UIcalendarNativeItemPicker = -11,
	UIcalendarNativeItemDatePicker = -12,
	
	UIcalendarNativeItemInfoLight = -13,
	UIcalendarNativeItemInfoDark = -14,
	
	UIcalendarNativeItemDisclosure = -15,
	
	UIcalendarNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all calendar instances of
