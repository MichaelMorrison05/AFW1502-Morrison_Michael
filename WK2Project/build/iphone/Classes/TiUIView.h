...
/**
 Base class for all WK2Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WK2Project view hierarchy (such as wrapped iOS UIViews) was touched.
