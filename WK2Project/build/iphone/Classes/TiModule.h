...
/**
 The base class for all WK2Project modules
 */
...
/**
 WK2Project Platform calls this method on startup.
 */
-(void)startup;

/**
 WK2Project Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 WK2Project Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 WK2Project Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 WK2Project Platform calls this method on resume.
 @param sender The sender of the event.
 */
