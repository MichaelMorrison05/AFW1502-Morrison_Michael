...
//@interface WK2ProjectObject : NSObject
//@end

@interface WK2ProjectObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[WK2ProjectObject class]])
		{
			for (NSString *key in [[(WK2ProjectObject*)o modules] allKeys])
			{
