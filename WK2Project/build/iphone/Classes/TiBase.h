...
// in simulator we redefine to format for WK2Project Developer console
...
{\
	NSString * exceptionName = [@"org.wk2project." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.wk2project";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWK2ProjectNativeItemNone = -1, 
	UIWK2ProjectNativeItemSpinner = -2,
	UIWK2ProjectNativeItemProgressBar = -3,
	
	UIWK2ProjectNativeItemSlider = -4,
	UIWK2ProjectNativeItemSwitch = -5,
	UIWK2ProjectNativeItemMultiButton = -6,
	UIWK2ProjectNativeItemSegmented = -7,
	
	UIWK2ProjectNativeItemTextView = -8,
	UIWK2ProjectNativeItemTextField = -9,
	UIWK2ProjectNativeItemSearchBar = -10,
	
	UIWK2ProjectNativeItemPicker = -11,
	UIWK2ProjectNativeItemDatePicker = -12,
	
	UIWK2ProjectNativeItemInfoLight = -13,
	UIWK2ProjectNativeItemInfoDark = -14,
	
	UIWK2ProjectNativeItemDisclosure = -15,
	
	UIWK2ProjectNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all WK2Project instances of
