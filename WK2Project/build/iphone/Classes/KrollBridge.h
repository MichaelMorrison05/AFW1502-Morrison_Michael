...
@interface WK2ProjectObject : KrollCoverageObject {
#else
@interface WK2ProjectObject : KrollObject {
#endif
@private
...
extern NSString * WK2Project$ModuleRequireFormat;
