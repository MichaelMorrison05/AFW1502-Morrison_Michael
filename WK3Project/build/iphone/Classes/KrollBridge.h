...
@interface WK3ProjectObject : KrollCoverageObject {
#else
@interface WK3ProjectObject : KrollObject {
#endif
@private
...
extern NSString * WK3Project$ModuleRequireFormat;
