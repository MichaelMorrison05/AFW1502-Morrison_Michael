...
/**
 Base class for all WK3Project views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the WK3Project view hierarchy (such as wrapped iOS UIViews) was touched.
