...
// in simulator we redefine to format for Week1Video Developer console
...
{\
	NSString * exceptionName = [@"org.week1video." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.week1video";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIWeek1VideoNativeItemNone = -1, 
	UIWeek1VideoNativeItemSpinner = -2,
	UIWeek1VideoNativeItemProgressBar = -3,
	
	UIWeek1VideoNativeItemSlider = -4,
	UIWeek1VideoNativeItemSwitch = -5,
	UIWeek1VideoNativeItemMultiButton = -6,
	UIWeek1VideoNativeItemSegmented = -7,
	
	UIWeek1VideoNativeItemTextView = -8,
	UIWeek1VideoNativeItemTextField = -9,
	UIWeek1VideoNativeItemSearchBar = -10,
	
	UIWeek1VideoNativeItemPicker = -11,
	UIWeek1VideoNativeItemDatePicker = -12,
	
	UIWeek1VideoNativeItemInfoLight = -13,
	UIWeek1VideoNativeItemInfoDark = -14,
	
	UIWeek1VideoNativeItemDisclosure = -15,
	
	UIWeek1VideoNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all Week1Video instances of
