...
@interface Week1VideoObject : KrollCoverageObject {
#else
@interface Week1VideoObject : KrollObject {
#endif
@private
...
extern NSString * Week1Video$ModuleRequireFormat;
