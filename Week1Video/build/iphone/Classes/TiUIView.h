...
/**
 Base class for all Week1Video views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the Week1Video view hierarchy (such as wrapped iOS UIViews) was touched.
