...
//@interface Week1VideoObject : NSObject
//@end

@interface Week1VideoObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[Week1VideoObject class]])
		{
			for (NSString *key in [[(Week1VideoObject*)o modules] allKeys])
			{
