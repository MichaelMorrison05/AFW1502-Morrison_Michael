...
//@interface videoObjectsObject : NSObject
//@end

@interface videoObjectsObject (Private)
...
void KrollPropertyNames(TiContextRef ctx, TiObjectRef object, TiPropertyNameAccumulatorRef propertyNames)
{
	...
	if (o)
	{
		...
		if ([o isKindOfClass:[videoObjectsObject class]])
		{
			for (NSString *key in [[(videoObjectsObject*)o modules] allKeys])
			{
