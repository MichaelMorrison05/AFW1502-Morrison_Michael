...
@interface videoObjectsObject : KrollCoverageObject {
#else
@interface videoObjectsObject : KrollObject {
#endif
@private
...
extern NSString * videoObjects$ModuleRequireFormat;
...
@private
	...
	NSMutableDictionary *modules;
	videoObjectsObject *_videoobjects;
    KrollObject* console;
	BOOL shutdown;
