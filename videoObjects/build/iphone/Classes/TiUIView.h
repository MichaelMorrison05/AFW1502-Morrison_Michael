...
/**
 Base class for all videoObjects views.
 @see TiViewProxy
 */
...
/**
 Whether or not a view not normally picked up by the videoObjects view hierarchy (such as wrapped iOS UIViews) was touched.
