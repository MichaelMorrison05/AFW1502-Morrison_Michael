...
//Rare exceptions to indicate a bug in the _videoobjects code (Eg, function that a subclass should have implemented)
...
/**
 The base class for videoObjects proxies.
 */
