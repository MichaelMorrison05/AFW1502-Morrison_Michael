...
// in simulator we redefine to format for videoObjects Developer console
...
{\
	NSString * exceptionName = [@"org.videoobjects." stringByAppendingString:NSStringFromClass([self class])];\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
\
+ (void) throwException:(NSString *) reason subreason:(NSString*)subreason location:(NSString *)location\
{\
	NSString * exceptionName = @"org.videoobjects";\
	TiExceptionThrowWithNameAndReason(exceptionName,reason,subreason,location);\
}\
...
enum {
	UIvideoObjectsNativeItemNone = -1, 
	UIvideoObjectsNativeItemSpinner = -2,
	UIvideoObjectsNativeItemProgressBar = -3,
	
	UIvideoObjectsNativeItemSlider = -4,
	UIvideoObjectsNativeItemSwitch = -5,
	UIvideoObjectsNativeItemMultiButton = -6,
	UIvideoObjectsNativeItemSegmented = -7,
	
	UIvideoObjectsNativeItemTextView = -8,
	UIvideoObjectsNativeItemTextField = -9,
	UIvideoObjectsNativeItemSearchBar = -10,
	
	UIvideoObjectsNativeItemPicker = -11,
	UIvideoObjectsNativeItemDatePicker = -12,
	
	UIvideoObjectsNativeItemInfoLight = -13,
	UIvideoObjectsNativeItemInfoDark = -14,
	
	UIvideoObjectsNativeItemDisclosure = -15,
	
	UIvideoObjectsNativeItemContactAdd = -16
};
...
/**
 *	TiThreadPerformOnMainThread should replace all videoObjects instances of
