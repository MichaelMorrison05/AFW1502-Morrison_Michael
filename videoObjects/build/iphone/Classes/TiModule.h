...
/**
 The base class for all videoObjects modules
 */
...
/**
 videoObjects Platform calls this method on startup.
 */
-(void)startup;

/**
 videoObjects Platform calls this method on shutdown.
 @param sender The sender of the event.
 */
-(void)shutdown:(id)sender;

/**
 videoObjects Platform calls this method on suspend.
 @param sender The sender of the event.
 */
-(void)suspend:(id)sender;

/**
 videoObjects Platform calls this method on entering background.
 @param sender The sender of the event.
 */
-(void)paused:(id)sender;

/**
 videoObjects Platform calls this method on resume.
 @param sender The sender of the event.
 */
